...
public class LibraryStudyRoom extends LibraryRoom {
	...
	public void drawFixture(CityWorldGenerator generator, RealBlocks chunk, Odds odds, int floor, int x,
		...
		switch (sideWithWall) {
		case NORTH:
			chunk.setBlocks(x, x + width, y, y + height, z, z + 1, Material.WOOD);
			chunk.setStair(x, y, z + 2, Material.WOOD_STAIRS, Stair.WEST);
			chunk.setTable(x + 1, y, z + 2);
			break;
		case SOUTH:
			chunk.setBlocks(x, x + width, y, y + height, z + depth - 1, z + depth, Material.WOOD);
			...
			break;
		case WEST:
			chunk.setBlocks(x, x + 1, y, y + height, z, z + depth, Material.WOOD);
			...
			break;
		case EAST:
			chunk.setBlocks(x + width - 1, x + width, y, y + height, z, z + depth, Material.WOOD);
